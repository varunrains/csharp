...
import { VolunteerService,StudyService } from './Volunteer.service';
...
export function MSALInterceptorConfigFactory(): MsalInterceptorConfiguration {
  ...
  protectedResourceMap.set(protectedResources.VolunteerListApi.endpoint, protectedResources.VolunteerListApi.scopes);
